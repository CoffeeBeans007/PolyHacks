...
everything=CointegrationA.cointegrationCacl("ZION","HIG",dataset[1],dataset[0],0.0001,-3.5,40)
...
for j in stocklist:
    ...
    alllogs.to_csv("fulllogs(30-7,-3.5,40).csv")
    try:
        dataset=CointegrationA.datasetprovider(stock1=j[0],stock2=j[1],week="52w",period="30m",backtrack=7)

        everything=CointegrationA.cointegrationCacl(j[0],j[1],dataset[1],dataset[0],0.0001,-3.5,40)
...
loggedreturns.to_csv("loggedreturns(30-7,-3.5,40).csv")
