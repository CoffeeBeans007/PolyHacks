...
if __name__ == '__main__':
    ...
    # convert_csv_to_parquet(csv_path=csv_path, parquet_path=parquet_path)

    # Read and save n_rows from the Parquet file
    read_n_rows_from_parquet(parquet_path=parquet_path, n_rows=n_rows, file_name=file_name)
