...
for column_name in data.columns:
    ...
    if data[column_name].isna().any():
        ...
        last_nan = data[column_name].index[data[column_name].isna()][-1]
        
        cut_downloaded_data = downloaded_data.iloc[len(downloaded_data)-len(data)-first_nan:-1]
        print(len(cut_downloaded_data))
        print(len(data[column_name].iloc[first_nan:last_nan]))
        data[column_name].iloc[first_nan:last_nan] = cut_downloaded_data.values
